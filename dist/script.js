...
var tabs = function tabs() {
  var bindModal = function bindModal(tabHeaderSelector, tabSelector, tabContantSelector, activeClass) {
    var tabHeader = document.querySelector(tabHeaderSelector);
    var tab = document.querySelectorAll(tabSelector);
    var tabContant = document.querySelectorAll(tabContantSelector);

    var hideContent = function hideContent() {
      tabContant.forEach(function (item) {
